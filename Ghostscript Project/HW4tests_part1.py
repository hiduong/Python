...
class HW4Sampletests_part1(unittest.TestCase):
    ...
    def testLookup3(self):
        ...
        psDef()    
        dictPush({'/x':[3,5,5]})
        self.assertEqual(lookup("x"),[3,5,5])
        self.assertEqual(lookup("p"),1000)
    ...
    def testLookup4(self):
        ...
        opPush([True,1,3,4])
        psDef()
        self.assertEqual(lookup("y"),True)
        self.assertEqual(lookup("o"),[True,1,3,4]) 
    # -------------------------
    ...
    def test_define4(self):
        ...
        define("/n1", True)
        dictPush({})
        define("/n2", [True,5,7,3])
        self.assertEqual(lookup("n1"),True)
        self.assertEqual(lookup("n2"),[True,5,7,3])

    def test_define5(self):
        dictPush({})
        define("/n1", 11111111111111111111111111111111111111)
        dictPush({})
        define("/n2", [True,5,767,False])
        define("/n1",123)
        self.assertEqual(lookup("n1"),123)
        self.assertEqual(lookup("n2"),[True,5,767,False])
    #-----------------------------------------------------
    ...
    def test_mul3(self):
        #2 40 mul
        opPush(0)
        opPush(11111111111111111122222222354789456)
        mul()
        self.assertEqual(opPop(),0)
    #-----------------------------------------------------
    ...
    def test_exch2(self):
        ...
        exch()
        self.assertEqual(opPop(),True)
        self.assertEqual(opPop(),10000)
    
    def test_exch3(self):
        opPush([1,2,3,4,True])
        opPush(10)
        exch()
        self.assertEqual(opPop(),[1,2,3,4,True])
        self.assertEqual(opPop(),10)
    #-------------------------------
    ...
    def test_pop2(self):
        ...
        pop()
        pop()
        self.assertEqual(1,len(opstack))
    ...
    def test_pop3(self):
        ...
        pop()
        pop()
        self.assertEqual(0,len(opstack))
    #-------------------------------
    ...
    def test_copy2(self):
        ...
        count()
        copy()
        self.assertTrue(opPop()==4 and opPop()==3 and opPop()==1 and opPop() == True and opPop()==4 and opPop()==3 and opPop()==1 and opPop()==True)
    ...
    def test_copy3(self):
        ...
        opPush(2)
        copy()
        self.assertTrue(opPop()==4 and opPop()==True and opPop()==4 and opPop()==True)
    ...
    def test_copy4(self):
        ...
        count()
        copy()
        self.assertTrue(opPop()==5 and opPop()==False and opPop()==[True] and opPop()==[1,2,3,4,5,6] and opPop()==5 and opPop()==False and opPop()==[True] and opPop()==[1,2,3,4,5,6] )
    #-------------------------------
    ...
    def test_clear2(self):
        opPush(True)
        opPush(False)
        opPush(1002222222222222222222222222222222222223333)
        opPush(-92222222222299992)
        clear()
        self.assertEqual(len(opstack),0)
    
    def test_clear3(self):
        opPush([1,2,3,True,6,7,9,0])
        opPush(0)
        opPush("Hello")
        clear()
        self.assertEqual(len(opstack),0)
    ...
    def test_length2(self):
        ...
        length()
        self.assertEqual(opPop(),0)      
        self.assertTrue(len(opstack)==1)

    def test_length3(self):
        opPush([-1000000,-1,5,True,4])
        opPush(2)
        pop()
        length()
        self.assertEqual(opPop(),5)      
    ...
    def test_getinterval2(self):
        opPush([4,True,5,10,False])
        opPush(0)
        opPush(4)
        getinterval()
        self.assertEqual(opPop(),[4,True,5,10])  
        self.assertTrue(len(opstack)==0)       

    def test_getinterval3(self):
        opPush([4,-10,3,5,5,True,4])
        opPush(1)
        opPush(6)
        getinterval()
        self.assertEqual(opPop(),[-10,3,5,5,True,4])         
        self.assertTrue(len(opstack)==0)
    #-------------------------------        
    ...
    #--------- My Tests ------------
    def test_put4(self):
        opPush([3,5,5,True,4,3,1,2,3,4,5,6,8])
        dup()  #duplicating the array reference
        opPush(4)
        opPush(0)
        put()  #put will not push back the changed array
        self.assertEqual(opPop(),[3,5,5,True,0,3,1,2,3,4,5,6,8])  #we pop the array reference we copied with "dup"
        self.assertTrue(len(opstack)==0)      
    ...
    def test_put5(self):
        ...
        opPush(False)
        put()  #put will not push back the changed array
        self.assertEqual(opPop(),[3,5,False,True,4])  #we pop the array reference we copied with "dup"
        self.assertTrue(len(opstack)==0)
    #-------------------------------  
    ...
    def test_putinterval2(self):
        ...
        dup() # we duplicate the array reference
        opPush(1)
        opPush([4,-1000,True,0])
        putinterval()
        self.assertEqual(opPop(),[0,4,-1000,True,0])
        self.assertTrue(len(opstack)==0)    

    def test_putinterval3(self):
        opPush([0,1,3,5,5,True,False,6,7,8,9,0])
        dup() # we duplicate the array reference
        opPush(0)
        opPush([4,5,1,0])
        putinterval()
        self.assertEqual(opPop(),[4,5,1,0,5,True,False,6,7,8,9,0])
        self.assertTrue(len(opstack)==0)
    ...
    def test_putinterval4(self):
        ...
        opPush([4,5,1,0])
        putinterval()
        self.assertEqual(opPop(),[0,1,3,5,5,True,False,6,7,8,9,0,4,5,1,0])
        self.assertTrue(len(opstack)==0)
    #------------------------------- 
    ...
    def test_psDef4(self):
        ...
        opPush(-10000)
        psDef()
        self.assertEqual(lookup('x'),True)
        self.assertEqual(lookup('y'),-10000) 

    def test_psDef5(self):
        dictPush({})
        opPush("/o")
        opPush(10)
        psDef()
        ...
        opPush([1,2,3,4])
        psDef()
        self.assertEqual(lookup('o'),0)
        self.assertEqual(lookup('y'),[1,2,3,4])
    #-------------------------------  
    ...
    def test_beginEnd2(self):
        ...
        opPush(False)
        psDef()
        self.assertEqual(lookup('x'),False) 
        self.assertEqual(lookup('y'),True)
        end() 
        self.assertEqual(lookup('x'),[1,2,3,4]) 

    def test_beginEnd3(self):
        opPush(1)
        psDict()
        begin()
        opPush("/o")
        ...
        opPush("Hello")
        psDef()
        self.assertEqual(lookup('x'),"Hello")
        end()
        self.assertEqual(lookup('y'),100000)
        end()  
        self.assertEqual(lookup('o'),True)
        end() 
    ...
    #----------THE TESTS BELOW DO RAISE/PRINTS AN ERROR MESSAGE-----------
    # I JUST UNCOMMENTED IT OUT AGAIN AFTER TESTING THEM
